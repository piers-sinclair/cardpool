...
>
> Card data is fetched from [YGOProDeck](https://ygoprodeck.com/) and errata history from [Yugipedia](https://yugipedia.com/). Users of this tool are responsible for complying with the terms of use of both services. Output files generated by this tool contain copyrighted card data and should not be publicly redistributed.
